...
This is the `v4` branch of dejavu browser. The currently deployed version on [dejavu.reactivesearch.io](https://dejavu.reactivesearch.io/) is on [`dev`](https://github.com/appbaseio/dejavu/tree/v4) branch. We also call the `dev` branch to be `v3`.
