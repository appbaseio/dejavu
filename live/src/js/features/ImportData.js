		...
		return (
			<div>
				...
				<Modal show={this.state.showModal} onHide={this.close}>
					...
					<Modal.Body>
						<p>Use appbase.io's <a href="https://github.com/appbaseio/transporter" target="_new">transporter <span className="fa fa-external-link" /></a> fork to import data from
						MongoDB, any JSON structure, or text file in three simple steps:
						</p>
						<ol>
							<li>Get the latest release for your system from
							<a href="https://github.com/appbaseio/transporter/releases/tag/v0.1.2-appbase" target="_new"> here <span className="fa fa-external-link" /></a>.</li>
