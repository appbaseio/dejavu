...
import { constants } from 'dejavu-data-browser';
      ...
      >
            ...
            >
              ...
              >
                <Form>
                  ...
                  >
                    {pastApps.find(app => app.appname === newApp)
                      ? null
                      : newApp.length && (
              ...
              >
                ...
                >
                  ...
                  <Button onClick={this.toggleModal} transparent>
                    <Text
                      css={{
                        fontSize: 14,
        ...
        >
          ...
          >
            ...
            >
              <img src={chromestore} alt="Chrome Store" width="70%" />
            </a>
            <Button
              css={button}
              shadow
